    ...
    <View style={styles.container}>
      ...
      <View style={[styles.cardContainer,]}>
        ...
        <View style={styles.cardBody}>
          <Text style={styles.titleAsuransi}>NAMA BANK</Text>
          <Text style={styles.bodyAsuransi}>NAMA AKUN</Text>
          <Text style={styles.bodyAsuransi}>NOMOR REKEING </Text>
          <Text style={styles.bodyAsuransi}>PENGGUNAAN</Text>
        </View>
      </View>
